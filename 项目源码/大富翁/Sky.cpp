...
void Sky::Draw(ID3D11DeviceContext* dc, XMFLOAT4X4 ViewProj, XMFLOAT3 position )
{
	// center Sky about eye in world space
	XMFLOAT3 eyePos = position;
	XMMATRIX T = XMMatrixTranslation(eyePos.x, eyePos.y, eyePos.z);

	XMMATRIX WVP = XMMatrixMultiply(T , XMLoadFloat4x4(&ViewProj));
